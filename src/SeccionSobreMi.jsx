...
function SeccionSobreMi(){
    ...
    <section id="sobremi">
        ...
        <div className="sobremi">
            ...
            <p>Soy una persona proactivo, con facilidad de aprender nuevas tecnologías en corto plazo, buen trato, trabajo en equipo. Mi buen desenpeño, me ha hecho destacar en organizaciones como uno de los desarrolles con mejor nivel de productivad y también ha permitido que desarrolles 
